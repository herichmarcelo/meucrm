 ...
 *
 * Cria a organização a partir de uma sessão ativa quando o provisionamento no
 * cadastro/confirmação falhou ou quando a confirmação de e-mail estava desligada.
 */
